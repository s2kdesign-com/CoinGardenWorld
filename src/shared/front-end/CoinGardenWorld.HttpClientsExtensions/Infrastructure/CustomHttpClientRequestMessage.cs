...
namespace CoinGardenWorld.HttpClientsExtensions.Infrastructure
{
    ...
    /// </summary>
    internal class CustomHttpClientRequestMessage : DataServiceClientRequestMessage, IDisposable
    {
        /// <summary>
        ...
        public CustomHttpClientRequestMessage(HttpClient client, DataServiceClientRequestMessageArgs args, DataServiceClientConfigurations config)
        ...
        {
            return UnwrapAggregateException(() => new CustomHttpClientResponseMessage(((Task<HttpResponseMessage>)asyncResult).Result, this.config));
        }
        ...
        public override IODataResponseMessage GetResponse()
        {
            return UnwrapAggregateException(() =>
            {
                var send = CreateSendTask();
                send.Wait();
                return new CustomHttpClientResponseMessage(send.Result, this.config);
            });
        }
#endif
