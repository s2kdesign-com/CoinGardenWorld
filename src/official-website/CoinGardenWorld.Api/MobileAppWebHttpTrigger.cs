...
namespace CoinGardenWorld.Api {
    public class AppWebHttpTrigger {
        ...
        public AppWebHttpTrigger(ILoggerFactory loggerFactory, AuthenticationProvider authentication) {
            _logger = loggerFactory.CreateLogger<AppWebHttpTrigger>();

            _authentication = authentication;
        }

        [Function(nameof(AppWebHttpTrigger.TestAuthenticatedEndpoint))]
        [OpenApiOperation(
