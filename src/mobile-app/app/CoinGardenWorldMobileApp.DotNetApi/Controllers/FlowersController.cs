...
namespace CoinGardenWorldMobileApp.DotNetApi.Controllers
{
    ...
    public class FlowersController : ControllerBase
    {
        ...
        public IQueryable<FlowerDto> GetPosts()
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<FlowerDto>> GetPost(Guid id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutPost(Guid id, FlowerMerge post)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<FlowerDto>> PostPost(FlowerAdd postAdd)
        {
            try
            {
