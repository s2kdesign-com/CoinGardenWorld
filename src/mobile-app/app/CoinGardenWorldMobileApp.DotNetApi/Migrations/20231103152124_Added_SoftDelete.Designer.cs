...
namespace CoinGardenWorldMobileApp.DotNetApi.Migrations
{
    ...
    [Migration("20231103152124_Added_SoftDelete")]
            ...
            modelBuilder.Entity("CoinGardenWorldMobileApp.Models.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("44dbc2e7-4dfb-42cf-b080-0f17fb5e03b6"),
                            CreatedFrom = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedOn = new DateTimeOffset(new DateTime(2023, 11, 3, 15, 21, 24, 510, DateTimeKind.Unspecified).AddTicks(3196), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Administrator"
                        });
                });
